...
- The solution architecture is "given" - it's a microservice. That's a "known thing." We don't have to invent it. All we have to do is implement it without doing anything [confusingly "clever"](https://uberconf.com/blog/neal_ford/2009/03/rubick_s_cubicle_soa__the_tarpit_of_irrelevancy_). (Assuming we can resist the temptation, that is.)
